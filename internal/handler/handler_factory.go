...
func NewStdioHandlerFromSupervisor(stdin io.Writer, stdout io.Reader, logger Logger, redisStorage bool) *StdioHandler {
	return NewStdioHandler(stdin, stdout, logger, redisStorage)
}
